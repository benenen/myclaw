...
func TestTMUXDriverInitUsesBotNameInSessionName(t *testing.T) {
	...
	wantCommand := "/usr/local/bin/codex -c " + tmux.ShellQuote(`projects."`+workDir+`".trust_level="trusted"`)
...
func TestBuildTMUXSessionOptionsUsesWorkspaceTrustConfig(t *testing.T) {
	...
	want := `/usr/local/bin/codex -c 'projects."/tmp/myclaw/bots/bot_1/workspace".trust_level="trusted"'`
